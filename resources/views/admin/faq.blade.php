            ...
            <div class="col-md-8 mt-4">
                <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Firstly, you need to create an {{ env('APP_NAME') }} account to use this website for the purpose
                            of
                            buying and selling
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Yes, you can start using your account to fund and withdraw immediately. However, there is a
                            funding
                            limit
                            of $500 per day, applicable to UN-VERIFIED accounts. No limitation on withdrawals. To get your
                            account
                            verified, you need to upload your ID showing your full name and a utility bill showing your
                            address.
                        </p>
                    </div>
                    <div class="col-md-12">
                        <h4>How long does it take to verify my account?</h4>
                        <p>After uploading your valid ID and an acceptable utility bill, verification usually takes 24 -
                            48hrs
                            (Monday - Saturday). If you receive no response after 48hrs, please Contact our support team
                            through
                            any
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Check that you have not received a response from us about the reason for this, by checking your
                            email
                            inbox. You may need to check your spam folder too. If no response has been received, you will
                            need
                            to
                            write us on {{ env('APP_Email') }} assistance or you can what's up us during the working hour.
                        </p>
                    </div>
                    <div class="col-md-12">
                        <h4>Do I need to verify my account to sell my E-currency to your company?</h4>
                        <p>No. Withdrawing your e-currency or selling it to us does not require any verification. We assume
                            AML
                            policy still holds since you will be accepting cash into your own very bank account. However,
                            your
                            banking details must match the name on your profile (name supplied during the registration). So,
                            you
                            can
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Occassionally, we allow this for withdrawal starting from $5,000 with a fee of 5% of the total
                            amount
                            of
                            e-currency withdrawn. Customer needs to communicate with us about this prior to withdrawal. We
                            can
                            be
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Transaction number or a reference number, both mean the same. From inside your iGN account, what
                            you
                            will
                            see is a REF which is a particular Transaction reference or number. It is a unique 6 digits code
                            for
                            a
                            particular transaction, either a funding or withdrawal and its very important to quote this
                            number
                            to
                    ...
                    <div class="col-md-12">
                        ...
                        <p>We try our best to make this instant but on some rare occassions, funding maybe extended to
                            24hrs.
                            Customers should be aware that sometimes it takes bank hours to get funds settled into our bank
                            accounts
                            for some reasons or there may be transactions in queue at our desk which need to be attended
                            before
                            yours. We urge customers to wait for at least 5hrs after deposit before submitting any complaint
                            of
                            funding.</p>
                    </div>
                    <div class="col-md-12">
                        <h4>I just made a withdrawal, how does it take you to deposite my bank account?</h4>
                        <p>We offer same day withdrawal but sometimes this maybe extended to 24hrs (Monday � Sunday). Note
                            that
                            your
                    ...
                    <div class="col-md-12">
                        ...
                        <p>No, we encourage a single account per customer only. This is to prevent duplicate and redundant
                            accounts
                            and to prevent money laundering. Customers are advised to verify their account so that they will
                            be
                            able
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Yes, you can pop into any of our offices near you to make a cash deposit or savely use the point
                            of
                            sales
                    ...
                    <div class="col-md-12">
                        ...
                        <p>We work 8:00am to 6:00pm (Monday - Friday) and 10:00am � 4:00pm (Saturday) and at our Managers
                            free
                            time
                            on Sundays. Our Support phone and live chat are available during the working hours of Monday �
                            Saturday
                            only. However, our managers work with email during the other days and hours so you can have your
                            buy
                            or
