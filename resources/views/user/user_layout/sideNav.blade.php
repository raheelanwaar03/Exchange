<div class="bg-dark mt-5">
    <div class="list-group">
        <a href="{{ route('user.buy.ecurrency') }}" class="list-group-item list-group-item-action active">
          Buy E-Currency
        </a>
        ...
        <a href="#" class="list-group-item list-group-item-action">Customer's Feedback</a>
      </div>
</div>
