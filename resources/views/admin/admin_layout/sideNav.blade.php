<div class="bg-dark mt-5">
    <div class="list-group">
        <a href="{{ route('admin.sellingRequest') }}" class="list-group-item list-group-item-action active">
          Buy E-Currency
        </a>
        <a href="{{ route('admin.buyingRequest') }}" class="list-group-item list-group-item-action">Sell E-Currency</a>
