        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>
                   ...
                   <b>1.0</b> “We” refers to {{ env('APP_NAME') }} (a website owned by Instantflexy & Tech Limited) and “You” refers to
                    anyone using the service of {{ env('APP_NAME') }}.
                    <br>
                    <br>
                    <b>1.1</b> We are not a financial institution and we are not a subsidiary of any e-payment system that we deal
                    in.
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <b>1.4</b> Our service is available to registered and verified customers only. Any deposit made to our bank
                    ...
                    <br>
                    <br>
                    <b>1.5</b> All transactions are made through our bank accounts listed on the account funding page which is only
                    ...
                    <br>
                    <br>
                    <b>1.5</b> For obvious security reasons, we do not provide our E-currency account numbers on this website.
                    ...
                    <br>
                    <br>
                    <b>1.7</b> You are responsible for supplying your correct E-currency account number. In the event that your
                    ...
                    <br>
                    <br>
                    <b>1.9</b> We will keep records of all transactions and we will make them available to relevant authorities
                    when necessary.
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <b>2.1</b> All transactions are concluded within 0 - 24 hours. If there is any delay in your account funding or
                    withdrawal, you will get in touch with our support department on the contact information listed on our
                    contact page.
                    <br>
                    <br>
                    <b>2.2</b> In the case you are spending your E-currency to us. We pay into your bank account the equivalent
                    ...
                    <br>
                    <br>
                    <b>2.3</b> We pay cash for the exact amount of the E-currency amount we receive into our E-currency account.
                    Please take notice of this, you are the one to bear the receiving fund fee at a particular time you make
                    a spend to us.
                    <br>
                    <br>
                    <b>2.4</b> In the event that your withdrawal was suspended, returned and/or cancelled by the money processor
                    for any reason. You are bound to make a full refund of any cash received from us.
                    <br>
                    <br>
                    <b>2.5</b> E-currency funding is final. You can not request a refund of your money once your e-currency account
                    has been funded.
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <b>2.7</b> We reserve the right to change the price of any of our products buy posting the information on our
